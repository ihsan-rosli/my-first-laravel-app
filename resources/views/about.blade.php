...
<body
    class="bg-gray-50 dark:bg-gray-900 text-gray-700 dark:text-gray-100 min-h-screen flex items-center justify-center">
    <div class="container mx-auto px-6 py-8">
        <div
            class="max-w-2xl mx-auto bg-white dark:bg-gray-800 rounded-lg shadow border border-gray-300 dark:border-gray-600 p-8">
            <div class="text-center space-y-4">
                <h1 class="text-2xl font-bold text-gray-700 dark:text-white mb-6">About {{ $name }}</h1>

                <div class="space-y-4 text-lg">
                    <p>Hello! I'm {{ $name }}, a {{ $title }} who loves creating amazing web applications.</p>

                    <p>Skills I'm working on:</p>
                    <ul class="text-left space-y-2 font-medium">
                    ...
                    <div class="mt-6">
                        ...
                        <ul class="text-left space-y-2">
                            ...
                            <li>• {{ $project['name'] }} - <span class="text-sm text-gray-600">{{ $project['status']
                                    }}</span></li>
                            @endforeach
                        </ul>
                    </div>
